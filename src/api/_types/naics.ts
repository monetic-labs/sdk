const NAICS_CODES = {
  ...
  '238120': 'Structual Steel and Precast Concrete Contractors',
  ...
  '311611': 'Animal (except Poutry) Slaughtering',
  ...
  '315220': "Men's and Boy's Cut and Sew Apparel Manufacturing",
  '315240':
    "Women's and Girl's, and Infant's Cut and Sew Apparel Manufacturing",
  ...
  '321918': 'Other Millwork (encluding Flooring)',
  ...
  '326113': 'Unlaminated Plastics and Sheet (except Packaging) Manufacturing',
  ...
  '336399': 'Other Motor Vehicle Parts Manufacturing',
  ...
  '441190': 'Other Building Material Dealers',
  ...
  '453910': 'Pet and Pet Supplies Store',
  '453920': 'Art Dealers',
  ...
  '474710': 'Petroleum Bulk Stations and Terminals',
  ...
  '519130': 'Internet Publishing and Broadcasting and Web Service Portals',
  ...
  '532210': 'Consumer Electronics and Applicances Rental',
  ...
  '711310':
    'Promotors of Performing Arts, Sports, and Similar Events with Facilities',
  '711320':
    'Promotors of Performing Arts, Sports, and Similar Events without Facilities',
  '711410':
...
const getNAICSCode = (code: string) => {
  return NAICS_CODES[code as keyof typeof NAICS_CODES];
};

const getNAICSCodeDescription = (code: string) => {
  return NAICS_CODES[code as keyof typeof NAICS_CODES];
};

/**
 * Gets the sector description for a NAICS code
 *
 * @param naicsCode - The full NAICS code (e.g. 111110)
 * @returns The sector description or undefined if not found
 */
const getNAICSSector = (naicsCode: string): string | undefined => {
  ...
  // Handle special cases for manufacturing, retail, and transportation
  if (sectorCode >= '31' && sectorCode <= '33') {
    return NAICS_SECTORS['31-33'];
  } else if (sectorCode >= '44' && sectorCode <= '45') {
    return NAICS_SECTORS['44-45'];
  } else if (sectorCode >= '48' && sectorCode <= '49') {
    return NAICS_SECTORS['48-49'];
  }

  return NAICS_SECTORS[sectorCode];
};
